export const NFTProgramId = 'privacyl_pridel_nftl_levent.aleo';

export const NFTProgram = `program privacyl_pridel_nftl_levent.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1ghm208yd7pfv2jxp69whzngkkx0mc24jjnslwmtxms7jq2ef2qyslyxn5s;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as privacyl_pridel_nftl_levent.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as privacyl_pridel_nftl_levent.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as privacyl_pridel_nftl_levent.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as privacyl_pridel_nftl_levent.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as privacyl_pridel_nftl_levent.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as privacyl_pridel_nftl_levent.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as privacyl_pridel_nftl_levent.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as privacyl_pridel_nftl_levent.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as privacyl_pridel_nftl_levent.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as privacyl_pridel_nftl_levent.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as privacyl_pridel_nftl_levent.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as privacyl_pridel_nftl_levent.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as privacyl_pridel_nftl_levent.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as privacyl_pridel_nftl_levent.aleo/convert_public_to_private.future;
